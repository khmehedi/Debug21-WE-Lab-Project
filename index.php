<?php include "inc/header.php" ?>
    ...
    <section class="teachers py-5 bg-teac-sec" >
      <div class="container mt-4 ">
        <center><h1 class="global-heading-col">Most Popular Teachers</h1></center>
        <center><h5 class="global-heading-col">(Teacher of the month)</h5></center>
      </div>
      <div class="container mt-5 px-5">
        <div class="row px-5 d-flex justify-content-center">
          <div class="col-md-3 teacher text-center">
            <center><img src="img/mehedi.png" width="70" class="img-fluid d-block rounded-circle" > </center>
            <p class="pt-2"> <a href="">KH Mehedi Hasan</a> </p>
          </div>
          <div class="col-md-3 teacher text-center">
            <center><img src="img/joy.png" width="70" class="img-fluid d-block rounded-circle" > </center>
            <p class="pt-2"> <a href="">Joy Ahmed</a> </p>
          </div>
          <div class="col-md-3 teacher text-center">
            <center><img src="img/rudro.png" width="70" class="img-fluid d-block rounded-circle" > </center>
            <p class="pt-2"> <a href="">Rudro Hasan</a> </p>
          </div>
          <div class="col-md-3 teacher text-center">
            <center><img src="img/zulhaz.png" width="70" class="img-fluid d-block rounded-circle" > </center>
            <p class="pt-2"> <a href="">Zulhaz Uddin Joy</a> </p>
          </div>
        </div>
      </div>
