            ...
            <div class="col-lg-4 col-xlg-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body little-profile text-center">
                        <div class="pro-img"><img src="../admin/img/<?php echo $t_ppic; ?>" alt="user"></div>
                ...
                <div class="card">
                    <div class="card-body bg-danger text-center">
                        ...
                        <a href="" class="text-warning" data-toggle="modal" data-target="#deleTeaMod">Delete this Student</a>
                    </div>
                </div>
                <!-- Column -->
            </div>
