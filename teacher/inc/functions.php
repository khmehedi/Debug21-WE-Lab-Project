...
if (isset($_POST['stu_complain'])) {
    ...
    $stu_comp       = $_POST['stu_comp'];
      ...
      $query = "INSERT INTO student_complain (stu_com_studentID, course_ID, stu_com_crsCode, stu_com_crsKey, stu_com_complaim) VALUES ( '$stuId_com', '$stuComCrsID', '$stuComCrsCode', '$stuComCrsKey', '$stu_comp')";
